...
import dev.tarasshablii.opora.microservices.initiatives.containers.TestContainers;
import dev.tarasshablii.opora.microservices.initiatives.endpoint.rest.dto.InitiativeServiceResponseDto;
import dev.tarasshablii.opora.microservices.initiatives.provider.persistence.InitiativesRepository;
...
import static dev.tarasshablii.opora.microservices.initiatives.InitiativesTestUtil.INITIATIVE_ID;
import static dev.tarasshablii.opora.microservices.initiatives.InitiativesTestUtil.MEDIA_ID;
import static dev.tarasshablii.opora.microservices.initiatives.InitiativesTestUtil.defaultInitiativeEntity;
...
class InitiativesIntegrationTest extends TestContainers {
    ...
    class CreateInitiativeTest {
        ...
        void createInitiative_shouldCreateNewInitiative() throws Exception {
            ...
            InitiativeServiceResponseDto dto = objectMapper.readValue(responseBody, InitiativeServiceResponseDto.class);
            assertThat(dto).isNotNull();
            assertThat(dto.getId()).isNotNull();
            assertThat(dto.getTitle()).isEqualTo("title");
            assertThat(dto.getDescription()).isEqualTo("description");
            assertThat(dto.getMedia()).isEqualTo(MEDIA_ID);
            assertThat(dto.getStatus()).isEqualTo(InitiativeServiceResponseDto.StatusEnum.ACTIVE);
