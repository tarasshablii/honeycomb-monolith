...
import dev.tarasshablii.opora.microservices.sponsors.containers.TestContainers;
import dev.tarasshablii.opora.microservices.sponsors.endpoint.rest.dto.SponsorServiceResponseDto;
import dev.tarasshablii.opora.microservices.sponsors.provider.persistence.ContactRepository;
import dev.tarasshablii.opora.microservices.sponsors.provider.persistence.SponsorRepository;
...
import static dev.tarasshablii.opora.microservices.sponsors.SponsorTestUtils.MEDIA_ID;
import static dev.tarasshablii.opora.microservices.sponsors.SponsorTestUtils.SPONSOR_ID;
import static dev.tarasshablii.opora.microservices.sponsors.SponsorTestUtils.defaultContactEntity;
import static dev.tarasshablii.opora.microservices.sponsors.SponsorTestUtils.defaultSponsorEntity;
...
class SponsorsIntegrationTest extends TestContainers {
    ...
    class CreateSponsorTest {
        ...
        void createSponsor_shouldCreateNewSponsor() throws Exception {
            ...
            SponsorServiceResponseDto dto = objectMapper.readValue(responseBody, SponsorServiceResponseDto.class);
